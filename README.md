...
|--------|----------|:-----:|
| `us-stock-analyst` | the research workflows + supporting capabilities, **incl. `sec-filings`** (US filings) | 14 |
| `international-analyst` | the above **+ FinMind** (Taiwan/TWSE market data) | 15 |
| `taiwan-stock-analyst` | Taiwan-focused: workflows + capabilities **+ FinMind**, minus `sec-filings` | 13 |
